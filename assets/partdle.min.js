...
null==I?I=Oa(a,!0):I.src=a;I.ha=[];Pa(I)}
...
0;return g}L=[];var c=document.querySelector("#gameWrapper"),d=document.querySelector("#practice");d||(d=document.createElement("div"),d.id="practice",document.body.appendChild(d));var f=document.querySelector("#practiceSVG");if(f)try{Array.from(f.children).forEach(function(e){return e.remove()})}catch(e){}else f=W("svg",{viewBox:"0 0 2048 2048"}),f.setAttribute("id","practiceSVG"),f.setAttribute("width","100%"),f.setAttribute("height","100%"),d.appendChild(f);if("undefined"!=typeof penDown)try{f.removeEventListener("mousedown",
...
window.btnSleep=function(a,b){a.disabled=!0;setTimeout(function(){a.disabled=!1},b)};window.newGame=pb;window.showAnswer=Ua;window.checkAnswer=fb;window.skipQuestion=function(){if(0<L.length){var a=Q.join(""),b=Ya(a);L.push({q:a,p:b,H:!0});a=["\u56de\u982d\u898b","\u5f85\u6703\u5152\u898b","See you later"];U("\uff5e"+a[Math.floor(Math.random()*a.length)]+"\uff5e","#00B0F0",.6);pb(!0)}else U("\u8acb\u52c7\u6562\u9762\u5c0d<br>\u9019\u662f\u6700\u5f8c\u4e00\u984c\u4e86","red")};
