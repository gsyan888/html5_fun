...
function fa(){this.j=!1;this.g=null;this.i=void 0;this.b=1;this.u=this.l=0;this.h=null}function ha(a){if(a.j)throw new TypeError("Generator is already running");a.j=!0}fa.prototype.m=function(a){this.i=a};function ia(a,c){a.h={H:c,I:!0};a.b=a.l||a.u}fa.prototype.return=function(a){this.h={return:a};this.b=this.u};function ja(a,c,d){a.b=d;return{value:c}}function ka(a){this.b=new fa;this.g=a}
...
function na(a){for(;a.b.b;)try{var c=a.g(a.b);if(c)return a.b.j=!1,{value:c.value,done:!1}}catch(d){a.b.i=void 0,ia(a.b,d)}a.b.j=!1;if(a.b.h){c=a.b.h;a.b.h=null;if(c.I)throw c.H;return{value:c.return,done:!0}}return{value:void 0,done:!0}}
...
((15>E?10>E?"5s":"8s":"10s")+'" path="'+t+'"  repeatCount="indefinite" /></circle>');f=m+("\n"+y+"\n")}return f+"</svg>\n"}return""}function Ja(a){var c,d,e;return qa(function(k){switch(k.b){case 1:return c="",d="https://stroke-order.learningweb.moe.edu.tw/provideStrokeInfo.do?ucs="+a.codePointAt(0).toString(16).toUpperCase(),k.l=2,ja(k,fetch(d),4);case 4:return e=k.i,ja(k,e.text(),5);case 5:c=k.i;k.b=3;k.l=0;break;case 2:k.l=0,k.h=null,c="";case 3:return k.return(c)}})}
function Ka(a){var c,d,e,k;return qa(function(m){if(1==m.b)return"string"!=typeof a&&(a="\u96c4"),c=null,ja(m,Ja(a),2);e=m.i;"string"==typeof e&&0<e.length&&e.match(/<Stroke>/i)&&(c=Ga(Fa(e)),k=new RegExp(V(a)+"\\t([^\\t]+)\\t([^\\t]+)\\t([^\\n]*)\n*"),(d=window.stroke_parts_data.match(k))&&3<d.length&&(c.K="/sound/"+(/\.m4a/.test(d[2])?d[2]:d[2]+".mp3"),c.A=d[3]));return m.return(c)})}
function La(){var a=Ma;Ca("https://gsyan888.github.io/html5_fun/html5_stroke_parts/stroke_parts_data.js",function(){"undefined"!=typeof window.stroke_parts_data&&null!=window.stroke_parts_data&&(window.stroke_parts_data=window.stroke_parts_data.trim().replace(/\r/g,"\n").replace(/\n+/g,"\n"));"function"==typeof a&&a()})}
function Na(a){Ca("https://gsyan888.github.io/html5_fun/html5_stroke_parts/stroke_component.js",function(){"string"==typeof window.stroke_component&&(window.stroke_component=window.stroke_component.trim().replace(/\r/g,"\n").replace(/\n+/g,"\n"));"function"==typeof a&&a()})}function W(a,c){a=document.createElementNS("http://www.w3.org/2000/svg",a);if(c)for(var d=Object.keys(c),e=0;e<d.length;e++){var k=d[e];a.setAttribute(k,c[k])}return a}
function Oa(a,c){a=a.getBoundingClientRect().toJSON();c=c.getBoundingClientRect().toJSON();a.left-=.1*a.width;a.right+=.1*a.width;a.top-=.1*a.height;a.bottom+=.1*a.height;return a&&c?c.left&&c.right&&c.top&&c.bottom?c.left>=a.left&&c.right<=a.right&&c.top>=a.top&&c.bottom<=a.bottom:c.x>=a.left&&c.x<=a.right&&c.y>=a.top&&c.y<=a.bottom:!1}
function Pa(a,c){if(c||"function"!=typeof AudioContext)return c=document.createElement("audio"),c.preload=!0,c.loop=!1,c.src=a,c;var d=new AudioContext,e=new XMLHttpRequest;e.open("GET",a);e.responseType="arraybuffer";e.onload=function(){d.decodeAudioData(e.response,function(k){d.C=k})};e.send();return d}
function Qa(a){if("undefined"!=typeof a&&null!=a)if("undefined"==typeof a.C&&"undefined"!=typeof a.play)a.load(),a&&0<a.currentTime&&!a.paused&&!a.ended&&2<a.readyState||a.play();else if(!(a&&0<a.currentTime&&!a.paused&&!a.ended&&2<a.readyState)){var c=a.createBufferSource();c.buffer=a.C;c.connect(a.destination);c.start()}}
function Ra(){if("undefined"==typeof A||null==A)A=Pa("https://gsyan888.github.io/html5_fun/assets/sound-ding-dong-ding-dong.mp3");if("undefined"==typeof D||null==D)D=Pa("https://gsyan888.github.io/html5_fun/html5_wheel/assets/sound_spin.mp3");if("undefined"==typeof H||null==H)H=Pa("https://gsyan888.github.io/html5_fun/assets/sound-coin.mp3")}
function Sa(a){var c="zh-TW";"string"!=typeof c&&(c="en-US");if(!/https:\/\//.test(a)){a=a.replace(/\.tts$/,"");/\.(\w{2}\-\w{2})$/.test(a)||(a+="."+c);var d=c="";/\.(\w{2}\-\w{2})$/.test(a)&&(a=window.RegExp.leftContext,d=window.RegExp.lastParen);isNaN(1)||(c="https://translate.google.com/translate_tts?ie=UTF-8&tl=${tts_language}&client=tw-ob&ttsspeed=${tts_speed}&q=".replace(/\$\{tts_language\}/i,""==d?"zh-TW":d),c=c.replace(/\$\{tts_speed\}/i,(1).toString()),c+=encodeURIComponent(a));a=c}"undefined"==
typeof L||null==L?L=Pa(a,!0):L.src=a;L.M=[];Qa(L)}
function Ta(){function a(f){var l=document.getElementById("practiceSVG").getScreenCTM();if(f.touches){for(var n=f.changedTouches[0].identifier,p=-1,q=0;q<f.touches.length;q++)if(f.touches[q].identifier==n){p=q;break}0>p&&(p=0);f=f.touches[p]}return{x:(f.clientX-l.e)/l.a,y:(f.clientY-l.f)/l.d}}function c(f){var l=-1;if("undefined"!=typeof f.changedTouches&&null!=f.changedTouches&&0<f.changedTouches.length){f=f.changedTouches[0].identifier;for(var n=0;n<m.length;n++)null!=m[n].id&&m[n].id==f&&(l=n)}else l=
...
penUp)}catch(f){}if("undefined"!=typeof penUp)try{k.removeEventListener("touchleave",penUp)}catch(f){}if("undefined"!=typeof penUp)try{k.removeEventListener("touchcancel",penUp)}catch(f){}var m=[];penDown=function(f){Ra();var l=f.target;if("path"==l.tagName||l.classList.contains("pathBg")||l.classList.contains("wordNG")){f.preventDefault();f.stopPropagation();var n={};"undefined"!=typeof f.changedTouches&&null!=f.changedTouches&&0<f.changedTouches.length&&(n.id=f.changedTouches[0].identifier);n.target=
...
e.setAttribute("class","message"),d.appendChild(e);e.setAttribute("style","opacity:0;")}function Ua(a){var c=0,d=document.querySelector("#practiceSVG");d&&(c=Math.floor((d.viewBox.baseVal.width-2048*S.length-40*(S.length-1))/2)+2088*a);return{x:c,y:1024}}
function Va(){var a,c=document.querySelector("#practiceSVG");if(c)for(var d=0;d<c.children.length;d++){var e=c.children[d],k=e.getAttribute("id");"g"==e.tagName&&"string"==typeof k&&(a=k.match(/([^-]+)-(\d+)-(\d+)/))&&(k=Ua(Number(a[2])),e.setAttribute("transform","translate("+k.x+" "+k.y+")"))}}
function Wa(){var a=document.querySelector("#practiceSVG");if(a)for(var c=0;c<S.length;c++){var d=Ua(c);d=W("g",{transform:"translate("+d.x+" "+d.y+")","stroke-width":3});var e="";e+='<rect width="2048" height="2048" fill="none" stroke="green" rx="150" ry="150" />\n';e+='<line x1="0" x2="2048" y1="1024" y2="1024" stroke="red" stroke-dasharray="50" />\n';e+='<line y1="0" y2="2048" x1="1024" x2="1024" stroke="red" stroke-dasharray="50" />\n';d.innerHTML=e;a.appendChild(d)}}
function Xa(a){var c,d,e,k,m,f,l,n,p,q,t,r,u,z,E,y,w,C,F,I;qa(function(M){if(1==M.b){if(!(0<R.length)){"function"==typeof a&&(Ya(),a());M.b=0;return}R.length==S.length&&(window.b=Array.from({length:Za(S)},function(J,B){return B}));c=Math.floor(Math.random()*R.length);d=R[c];R.splice(c,1);e=S[d];return ja(M,Ka(e),3)}k=M.i;m=Ia(e,k);f=new DOMParser;l=f.parseFromString(m,"text/html");n=$a(e);p=document.querySelector("#practiceSVG");q=p.viewBox.baseVal;t=2048*d;r="translate("+t+" 1024)";u=l.querySelectorAll("g");
...
B=(500>K?1.5:1351.68>K?1:.75)*K/2;var Da=(500>G?1.5:1351.68>G?1:.75)*G/2;O+=K/2;P+=G/2;K="fill:#ffffff;fill-opacity:0.001; stroke:none;stroke-opacity:0;";"1"==X("debug")&&(K="fill:#ffff00;fill-opacity:0.1; stroke:none;stroke-opacity:0;");B=W("ellipse",{"class":"pathBg",cx:O,cy:P,rx:B,ry:Da,style:K});J=J.parentElement;J.insertBefore(B,J.children[0])}),n&&n[y]&&u[y].setAttribute("cns",n[y]),w=u[y].getBBox(),Za(S),c=Math.floor(Math.random()*window.b.length),C=window.b[c],window.b.splice(c,1),F=q.width/
2-w.width/2-w.x,I=q.height/2-w.height/2-w.y,u[y].setAttribute("transform","translate("+F+" "+I+")"),u[y].setAttribute("fill",x[C%x.length]);Xa(a);M.b=0})}
function Ya(){var a=document.querySelector("#practiceSVG");if(a){var c=a.viewBox.baseVal,d=c.width/Za(S),e=Array.from({length:Za(S)},function(t,r){return r});a=a.querySelectorAll("g");for(var k=0;k<a.length;k++){var m=a[k];if(/[^-]+-\d+-\d+/.test(m.getAttribute("id"))){var f=m.getBBox(),l=Math.floor(Math.random()*e.length),n=e[l],p=n*d-f.x;p=0>p-f.width/2?f.width/2-f.x:p-f.width/2;p+f.width+2*f.x>c.width&&(p=c.width-f.width-f.x-50);var q=2048*(1-Math.floor(3*Math.random()))/5-f.y-f.height/2;1024<
q+f.y+f.height&&(q=974-f.height-f.y);e.splice(l,1);m.setAttribute("transform","translate("+p+" "+q+")");m.setAttribute("fill",x[n%x.length])}}ab()}}function Za(a){for(var c=0,d=0;d<a.length;d++){var e=void 0;var k="";(e=window.stroke_parts_data.match(new RegExp(V(a[d])+"\\t([^\\t]+)\\t([^\\t]+)\\t([^\\n]*)\n*")))&&3<e.length&&(k=e[3]);e=k;""!==e?c+=Ea(e,0).length:c++}return c}
function $a(a){var c=[],d;"undefined"==typeof window.stroke_component||null==window.stroke_component?Na():(d=window.stroke_component.match(new RegExp(V(a)+"\\t([^\\n]*)\n*")))&&2<=d.length?c=d[1].trim().split(";")[0].split(","):c.push(a);return c}
function bb(a){var c=S;"string"==typeof c&&(c=Array.from(c));var d="";c.forEach(function(e){return d+=(""==d?"":" AND")+" A LIKE '%"+e+"%'"});cb("https://docs.google.com/spreadsheets/d/1gXpIr34zH65D50td6vnuKbM4yy1WPNQTbReDguCy5lY/edit?usp=sharing","SELECT * WHERE "+d,!0,!0,function(e){var k=[];if("undefined"!=typeof e&&null!=e&&"string"==typeof e.status&&"ok"==e.status){var m=e.table;if("undefined"!=typeof m.rows&&null!=m.rows&&1<m.rows.length&&(e=e.table.rows.filter(function(f){return f.c&&f.c[0].v.length==
c.length}),1<e.length))for("string"!=typeof c&&(c=c.join("")),m=0;m<e.length;m++)e[m].c[0].v!=c&&k.push(e[m].c[0].v.trim())}"function"==typeof a?a(k):console.log(JSON.stringify(k))})}function db(a){var c,d={x:0,y:0};(a=a.getAttribute("transform"))&&(c=a.match(/translate\s*\(([^\)]+)\)/i))&&(c=c[1].split(/\s+/))&&2==c.length&&(d.x=Number(c[0]),d.y=Number(c[1]));return d}
function eb(){var a=[],c,d=document.querySelector("#practiceSVG");if(d){for(var e=0;e<S.length;e++)a[e]={},a[e].a=[],a[e].w={},a[e].cns=[];for(e=S.length;e<d.children.length;e++){var k=d.children[e],m=k.getAttribute("id");if("g"==k.tagName&&"string"==typeof m&&(c=m.match(/([^-]+)-(\d+)-(\d+)/))){var f=c[1];m=k.getAttribute("cns");for(var l=0;l<a.length;l++)if(Oa(d.children[l],k)){a[l].a.push(k);a[l].cns.push(m);null==a[l].w[f]?a[l].w[f]=1:a[l].w[f]++;break}}}c=[];d=S.slice();for(e=0;e<a.length;e++){k=
a[e].cns.length;f=Object.keys(a[e].w);for(l=0;l<f.length;l++)if(m=$a(f[l]),m.length!=k)delete a[e].w[f[l]];else{for(var n=0;n<k&&0<m.length;n++)for(var p=0;p<m.length;p++)if(m[p]==a[e].cns[n]){m.splice(p,1);break}0<m.length&&delete a[e].w[f[l]]}m=Object.keys(a[e].w).length;if(0==m)c.push(e),console.log("NG: ",e,a[e]);else if(1==m)for(n=0;n<d.length;n++)if(d[n]==Object.keys(a[e].w)[0]){d.splice(n,1);break}}for(e=0;e<c.length;e++)for(k=a[c[e]].cns.length,n=0;n<d.length;n++)if(f=d[n],m=$a(f),m.length==
...
function fb(){for(var a="",c=eb(),d=c.length-1,e=0;e<=d;e++){var k=c[e],m=Object.keys(k.w);m.sort(function(t,r){return k.w[t]-k.w[r]});for(var f=0;f<m.length;f++){var l=m[f],n=$a(l);if(k.cns.length==n.length){for(var p=0;p<k.cns.length&&0<n.length;p++)for(var q=0;q<n.length;q++)if(k.cns[p]==n[q]){n.splice(q,1);break}if(0==n.length){a+=l;break}}}}return{term:a,rect:c}}
function gb(a){function c(w,C){var F=null;if(w&&w.a&&1<w.a.length&&"string"==typeof C){w.a=w.a.sort(function(Da,ub){return e(ub)-e(Da)});for(var I=db(w.a[0]),M=0;M<w.a.length;M++){var J=w.a[M],B=J.getAttribute("id"),O=J.getAttribute("cns"),P=B.match(/([^-]+)-(\d+)-(\d+)/)[1],K=!0;O=t.querySelectorAll('g[id*="'+C+'"][cns="'+O+'"]');if(P==C){var G=db(J);204.8>=Math.abs(G.x-I.x)&&204.8>=Math.abs(G.y-I.y)&&(K=!1)}if(K&&0<O.length)for(P=0;P<O.length;P++)if(G=O[P],G.getAttribute("id")!=B&&(G=d(J,G),204.8>=
Math.abs(G.x-I.x)&&204.8>=Math.abs(G.y-I.y))){K=!1;break}if(K){F=J;break}}}return F}function d(w,C){var F=C.getBBox(),I=w.getBBox();C=I.x-F.x+(I.width-F.width)/2;F=I.y-F.y+(I.height-F.height)/2;w=db(w);w.x+=C;w.y+=F;return w}function e(w){w=w.getBBox();return w.width*w.height}function k(w){if(w){var C=w.getBBox();C=W("rect",{"class":"hintRect",width:C.width,height:C.height,x:C.x,y:C.y,style:"fill:#ffff00;fill-opacity:0.5;stroke:#ff0000;stroke-width:20;stroke-opacity:0.25"});w.insertBefore(C,w.children[0])}else(w=
document.querySelectorAll(".hintRect"))&&Array.from(w).forEach(function(F){return F.remove()})}var m=!0,f=null,l=0,n=0,p=[];if("string"==typeof a){var q=("string"==typeof S?S:S.join("")).trim();a=a.trim();if(a.length>=q.length)p=new RegExp(V(q)),p.test(a)||("function"==typeof hb?(q=hb(q),a=hb(a),p=new RegExp(V(q)),p.test(a)||(m=!1)):m=!1);else return!1}else{Ra();for(q=0;q<S.length;q++)p[q]={},p[q].q=$a(S[q]),p[q].a=[],l+=p[q].q.length;var t=document.querySelector("#practiceSVG");if(t)for(q=0;q<t.children.length;q++){var r=
t.children[q],u=r.getAttribute("id");if("g"==r.tagName&&"string"==typeof u&&u.match(/([^-]+)-(\d+)-(\d+)/)){u=r.getAttribute("cns");for(var z=0;z<p.length;z++)if(Oa(t.children[z],r)){p[z].a.push(r);n++;break}}}for(q=0;q<p.length;q++){r=p[q];if(r.a.length!=r.q.length){m=!1;break}var E=r.q.slice(0);for(z=0;z<r.a.length;z++){u=r.a[z].getAttribute("cns");for(var y=0;y<E.length;y++)if(u==E[y]){E.splice(y,1);break}}if(0<E.length){m=!1;break}}if(m)for(q=0;q<p.length;q++)if(r=p[q],u=c(r,S[q])){k(u);setTimeout(function(){k()},
250);U("\u52a0\u6cb9<br>\u7b2c "+(q+1)+" \u500b\u5b57\u518d\u6392\u597d\u4e00\u9ede","#ff6699a0",.75);"undefined"!=typeof D&&null!=D&&Qa(D);return}}if(m||"string"==typeof a)ib(m,n,l,f);else if(a=fb(),Array.from(a.term).length==S.length){console.log("search dic: "+a.term);U("\u5b57\u62fc\u5c0d\u4e86\uff0c\u8a5e\u4e0d\u540c<br>\uff5e\u67e5\u5b57\u5178\u4e2d\uff0c\u8acb\u7a0d\u5019\uff5e","#FF94B8",2);document.querySelector(".checkBtn").enable=!1;f="";if(0<va.length)for(q=0;q<va.length;q++)if(a.term==
va[q]){f=a.term;break}if(""!=f)for(q=0;q<a.rect.length;q++)if(r=a.rect[q],u=c(r,Object.keys(a.rect[q].w)[0])){k(u);setTimeout(function(){k()},250);U("\u52a0\u6cb9<br>\u7b2c "+(q+1)+" \u500b\u5b57\u518d\u6392\u597d\u4e00\u9ede","#ff6699a0",.75);"undefined"!=typeof D&&null!=D&&Qa(D);return}ib(""!=f,n,l,f)}else ib(m,n,l,f);return m}
function ib(a,c,d,e){var k="";if(a){Va();a=100;c="green";d=1.5;0==N.length?(k="\u5df2\u7d93\u5168\u90e8\u6311\u6230\u5b8c\uff5e\u52a05000\u5206",a=5E3,c="#56B4E9",d=3):k="\u606d\u559c\u904e\u95dc!!";U('<span style="color:#99cc33;font-size:1.25em;">\u592a\u68d2\u4e86</span><br>'+k,c,d,function(){var m=document.querySelector("#nextBtn");m&&m.classList.toggle("hidden",!1);jb(S,e)});"undefined"!=typeof A&&null!=A&&Qa(A);k="";"string"!=typeof S&&(k=S.join(""));"string"==typeof e&&""!=e&&(k+=","+e);""!=
k&&Sa(k);k=[".checkBtn",".skipBtn",".randomBtn"];for(c=0;c<k.length;c++)(d=document.querySelector(k[c]))&&d.classList.toggle("hidden",!0);kb(a)}else k=c<d&&"string"!=typeof answerTxt?"\u8acb\u6aa2\u67e5\u90e8\u4ef6\u662f\u5426\u90fd\u5b8c\u6574\u5730\u5728\u65b9\u683c\u5167<br>\u6709 "+(d-c)+" \u500b\u9700\u8981\u8abf\u6574\u4f4d\u7f6e":"\u54e6~ \u54e6~~ \u518d\u8a66\u8a66",U('<span style="color:yellow;font-size:1.25em;">\u52a0\u6cb9</span><br>'+k,"red",3),"undefined"!=typeof D&&null!=D&&Qa(D)}
function lb(a){var c=document.createElement("textarea");c.innerHTML=a;return c.value}
function U(a,c,d,e){d||(d=2);if("undefined"==typeof c||null==c)c="#44AF49";var k=document.querySelector(".message");"hidden"!=getComputedStyle(k).getPropertyValue("visibility")?(k.innerHTML=a,k.style.display="block",k.style["background-color"]=c,k.style.opacity=.75,k.style.transition="opacity "+d+"s ease-out",setTimeout(function(){k.style.opacity=0;"function"==typeof e&&e()},Math.floor(1E3*d))):alert(lb(a).replace(/<br>/g,"\n"))}var Y=1,mb=1;
function nb(a){"boolean"!=typeof a&&(a=!1);if("undefined"!=typeof Q&&null!=Q&&1<Q.length){if("undefined"==typeof N||null==N||0==N.length){var c=Q.split(/\n+/).filter(function(m){return""!=m.replace(/\s/g,"")});N=Array.from({length:c.length},function(m,f){return{q:c[f],p:Za(c[f]),B:!1}});N.sort(function(m,f){return m.p-f.p});ua=N.length;Y=N[0].p;mb=Y+1}var d=N[N.length-1].p;for(var e=[];Y<=d&&0<N.length;)if(e=N.filter(function(m){return m.p>=Y&&m.p<=mb&&!m.B}),0==e.length)Y++,mb++;else if(3<N.filter(function(m){return!m.B}).length&&
3>=e.length)mb++;else break;Y==N[0].p||N[0].B||(a||(U("\u606d\u559c\u5347\u7d1a<br>\u52a0\u767c\u9ede\u6578 1000","blue",2),kb(1E3)),Y=N[0].p);e=0<e.length?e.filter(function(m){return m.p==Y}):N.slice(0);var k=Math.floor(Math.random()*e.length);d=Array.from(e[k].q.trim());N=N.filter(function(m){return m.q!=e[k].q});"function"==typeof ob&&ob(ua-N.length)}return d}
function ab(){var a=document.querySelector("#practiceSVG"),c=Array.from(a.children);c.splice(0,S.length);c.sort(function(d,e){d=d.getBBox();e=e.getBBox();return e.width*e.height-d.width*d.height});c.forEach(function(d){return d.remove()});c.forEach(function(d){return a.appendChild(d)})}
function pb(){var a=document.querySelector("#practice"),c=document.querySelector("#practiceSVG");if(c&&a&&"undefined"!=typeof S&&null!=S){var d=a.getBoundingClientRect();a=d.width/S.length;d=d.height/2.25;var e=1;a>d&&(e=a/d);c.setAttribute("viewBox","0 0 "+Math.floor(2048*S.length*e+40*(S.length+1))+" 2048");c.setAttribute("width","100%");c.setAttribute("height","100%")}}
function qb(a){"boolean"!=typeof a&&(a=!1);Array.from(document.querySelector("#practiceSVG").children).forEach(function(d){return d.remove()});var c=document.querySelector("#nextBtn");c&&c.classList.toggle("hidden",!0);jb();S=nb(a);"undefined"!=typeof S&&null!=S&&0<S.length&&("string"==typeof S&&(S=Array.from(S.trim())),bb(function(d){va=d}),pb(),Wa(),R=Array.from({length:S.length},function(d,e){return e}),Xa(function(){ab();for(var d=[".checkBtn",".skipBtn",".randomBtn"],e=0;e<d.length;e++){var k=
document.querySelector(d[e]);k&&k.classList.toggle("hidden",!1)}ta&&(U('<span style="color:#ffff00;font-size:1.25em;">\u958b\u59cb\u95d6\u95dc</span><br>\u8acb\u5c07\u90e8\u4ef6\u62d6\u66f3\u5230\u65b9\u6846\u4e2d\u62fc\u6210\u5b57<br>\u8a9e\u8a5e\u62fc\u597d\u4e86\uff0c\u5c31\u6309 [\u9001\u51fa\u7b54\u6848] \u9215',"orange",3),ta=!1)}))}var Z=null;function rb(){var a=document.getElementById("micButton");a&&(a.style["background-color"]="dodgerblue");Z&&"function"==typeof Z.stop&&Z.stop()}
...
a&&c&&(c=300,gb(a)?rb():c=1E3,document.getElementById("micButton").b.innerText=a,setTimeout(function(){document.getElementById("micButton").b.innerText=""},c))};Z.onerror=function(a){var c="\u932f\u8aa4\u4ee3\u78bc\u53ca\u8a0a\u606f: ["+a.error+"] ["+a.message+"]";/not-allowed/i.test(a.error)?U("\u7121\u6cd5\u4f7f\u7528\u8a9e\u97f3\u8fa8\u8b58(\u53ef\u80fd\u9700\u8981\u6aa2\u67e5\u9ea5\u514b\u98a8\u8a2d\u5b9a\u3001\u5b89\u5168\u3001\u96b1\u79c1\u8a2d\u5b9a\uff1b\u6216\u662f\u8acb\u63db\u4e00\u7a2e\u700f\u89bd\u5668\u518d\u8a66\u8a66)<br>"+
...
function tb(a){"function"==typeof Ra&&Ra();a.preventDefault();a=document.getElementById("micButton");if("function"==typeof window.SpeechRecognition||"function"==typeof window.webkitSpeechRecognition||"function"==typeof window.g||"function"==typeof window.h){if("undefined"==typeof Z||null==Z)Z=new (window.webkitSpeechRecognition||window.SpeechRecognition||window.g||window.h),Z.continuous=!0,Z.interimResults=!0,Z.lang="zh-TW","string"==typeof wa&&""!=wa&&(Z.lang=wa),Z.interimResults=!0,sb();if("dodgerblue"==
a.style["background-color"].toLowerCase())if((a=document.querySelector(".checkBtn"))&&a.classList.contains("hidden"))U("\u8acb\u5148\u6309\u4e0b\u4e00\u984c<br>\u624d\u80fd\u555f\u52d5\u8a9e\u97f3\u8f38\u5165\u7684\u529f\u80fd","red");else try{Z.start()}catch(c){setTimeout(function(){Z.start()},100)}else try{rb()}catch(c){}}else alert("\u62b1\u6b49~ \u60a8\u7684\u700f\u89bd\u5668\u4e0d\u652f\u63f4\u8a9e\u97f3\u8fa8\u8b58(webkitSpeechRecognition)\u7684\u529f\u80fd"),a.removeEventListener("mousedown",
...
"undefined"!=typeof p&&null!=p?"string"==typeof p.v&&""!=p.v.replace(/\s/g,"")?m+=p.v.trim()+"\n":e||(m+="\n"):e||(m+="\n")}""!=m?"function"==typeof k?k(m):console.log(m):("undefined"!=typeof l&&null!=l&&"undefined"!=typeof l.table&&console.log(l.table),T=!1,U("\u7121\u6cd5\u8f09\u5165\u984c\u5eab<br>\u8acb\u78ba\u8a8d\u8a66\u7b97\u8868\u4e2d\u7684\u5167\u5bb9\u5f8c\u518d\u8a66","red",10,function(){zb(0)}))}})}else T=!1,U("\u7121\u6cd5\u8f09\u5165\u984c\u5eab<br>\u7db2\u5740\u4f3c\u4e4e\u4e0d\u662f\u8a66\u7b97\u8868\u7684\uff0c\u8acb\u78ba\u8a8d\u5f8c\u518d\u8a66",
"red",10,function(){zb(0)})}function Ab(a,c,d,e,k){function m(l){f||(f=l);l=Math.min((l-f)/e,1);a.innerHTML=Math.floor(l*(d-c)+c);1>l?window.requestAnimationFrame(m):"function"==typeof k&&k()}var f=null;window.requestAnimationFrame(m)}function kb(a){function c(){"undefined"!=typeof H&&null!=H&&Qa(H)}var d=document.querySelector(".score");if("number"!=typeof a)d.innerHTML="0",c();else{var e=parseInt(d.innerHTML,10);Ab(d,e,e+a,50>a?500:1E3,function(){c()})}}
function ob(a){var c=document.querySelector(".q-number"),d="^_^";c&&("number"==typeof a&&(d=a+" / "+ua),c.innerHTML=d)}
function jb(a,c){var d=document.querySelector(".dicLink");d&&("undefined"==typeof a||null==a?a="":("string"!=typeof a&&(a=a.join("")),"undefined"==typeof c||null==c?a='<a href="https://pedia.cloud.edu.tw/Entry/Detail?title='+encodeURIComponent(a)+'#" target="_blank">\u67e5\u770b\u6559\u80b2\u96f2-\u6559\u80b2\u767e\u79d1 ['+a+"] \u7684\u89e3\u91cb</a>":(a='\u67e5\u770b\u6559\u80b2\u96f2-\u6559\u80b2\u767e\u79d1\u7684\u89e3\u91cb &gt;&gt; [<a href="https://pedia.cloud.edu.tw/Entry/Detail?title='+(encodeURIComponent(a)+
...
function Db(){for(var a=null,c=document.getElementsByTagName("meta"),d=0;d<c.length;d++)if("referrer"==c[d].name){a=c[d];break}null==a&&(a=document.createElement("meta"),a.name="referrer",document.getElementsByTagName("head")[0].appendChild(a));a.content="no-referrer"}
...
function Ma(){if("undefined"!=typeof window.stroke_parts_data&&null!=window.stroke_parts_data){document.querySelector(".loading-label").innerHTML="\u8f09\u5165\u984c\u5eab";Ta();var a=X("id"),c=X("gid"),d=X("col"),e="https://docs.google.com/spreadsheets/d/1kBueULlojPOH9E3EZYEUcUAv1HfJm_wULQT1hT2m1nM/edit?usp=sharing";""==a.replace(/\s/g,"")?""!=c&&(e=/gid=/.test(e)?e.replace(/gid=([^&\?#]+)/g,"gid="+c):e+((/\?/.test(e)?"&":"?")+"gid="+c+"#"+c)):e="https://docs.google.com/spreadsheets/d/"+a+"/edit?"+
(""==c?"usp=sharing":"?gid="+c+"#"+c);a=null;""!=d.replace(/\s|[^a-z]/ig,"")&&(a="SELECT "+d.toUpperCase());cb(e,a,!1,!1,function(k){T=!1;Q=k.trim();var m=parseInt(X("lesson"),10);isNaN(m)||(k=Q.split(/\n\n+/),0<=m&&m<=k.length&&(Q=k[m-1]));ta=!0;qb()});wb()}else setTimeout(function(){T=!1;U("HTML5 FUN \u90e8\u4ef6\u8a2d\u5b9a\u8f09\u5165\u5931\u6557<br>\u8acb\u6aa2\u67e5\u5f8c\u518d\u8a66","red",5,function(){zb(0)})},500)}
function Fb(){function a(){"undefined"!=typeof window.stroke_component&&null!=window.stroke_component?"undefined"==typeof window.stroke_parts_data||null==window.stroke_parts_data?La():Ma():setTimeout(function(){U("CNS \u90e8\u4ef6\u8a2d\u5b9a\u8f09\u5165\u5931\u6557<br>\u8acb\u6aa2\u67e5\u5f8c\u518d\u8a66","red",5,function(){zb(0)});T=!1},500)}document.querySelector(".loading-label").innerHTML="\u8f09\u5165\u8a2d\u5b9a";"undefined"==typeof window.stroke_component||null==window.stroke_component?Na(a):
a()}function Bb(a){for(var c=3;10>=c;c++)try{document.querySelector("#aswift_"+c).parentElement.parentElement.style.scale=a}catch(d){}}function Gb(){try{"function"==typeof Bb&&Bb(.001)}catch(a){}Cb();Db();zb(!0);window.scrollTo(0,0);document.querySelector(".debug").innerHTML="";T=!0;Eb();Ra();Sa("\u52a0\u6cb9");setTimeout(function(){kb();ob();jb()},100);Fb()}var Hb=X("autostart");"1"!=Hb&&"true"!=Hb||Gb();window.setVisibility=zb;
window.btnSleep=function(a,c){a.disabled=!0;setTimeout(function(){a.disabled=!1},c)};window.newGame=qb;window.showAnswer=Va;window.checkAnswer=gb;window.skipQuestion=function(){if(0<N.length){var a=S.join(""),c=Za(a);N.push({q:a,p:c,B:!0});a=["\u56de\u982d\u898b","\u5f85\u6703\u5152\u898b","See you later"];U("\uff5e"+a[Math.floor(Math.random()*a.length)]+"\uff5e","#00B0F0",.6);qb(!0)}else U("\u8acb\u52c7\u6562\u9762\u5c0d<br>\u9019\u662f\u6700\u5f8c\u4e00\u984c\u4e86","red")};
window.randomPosition=Ya;
window.fileURL_onBlurHandler=function(a){var c="";a.value&&/^https:\/\//i.test(a.value)&&/spreadsheets/.test(a.value)&&(c=Ba(a.value));if(""==c)Aa(),a.value&&""==a.value.replace(/\s/g,"")?Aa():setTimeout(function(){U("\u8acb\u8f38\u5165 Google \u8a66\u7b97\u8868\u7684\u5171\u7528\u7db2\u5740")},100);else{try{document.querySelector("#previewBtn").style.display="none",document.querySelector("#submitBtn").style.display="block"}catch(d){}cb(a.value,"SELECT * LIMIT 2",!0,!0,function(d){var e="";if("undefined"!=
